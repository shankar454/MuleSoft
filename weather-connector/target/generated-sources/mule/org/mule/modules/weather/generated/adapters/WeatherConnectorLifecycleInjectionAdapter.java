...
/**
 * A <code>WeatherConnectorLifecycleInjectionAdapter</code> is a wrapper around {@link WeatherConnector } that adds lifecycle methods to the pojo. This adapter also allows the injection of several Mule facilities when a MuleContext is set.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.0", date = "2016-09-09T06:05:19-07:00", comments = "Build UNNAMED.2793.f49b6c7")
public class WeatherConnectorLifecycleInjectionAdapter
    extends WeatherConnectorMetadataAdapter
    implements MuleContextAware, Disposable, Initialisable, Startable, Stoppable
{
    ...
    {
        Logger log = LoggerFactory.getLogger(WeatherConnectorLifecycleInjectionAdapter.class);
