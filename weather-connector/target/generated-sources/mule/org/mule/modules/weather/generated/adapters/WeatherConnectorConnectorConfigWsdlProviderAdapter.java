...
/**
 * A <code>WeatherConnectorConnectorConfigWsdlProviderAdapter</code> is a wrapper around {@link WeatherConnector } that represents the WSDL generic connector {@link ConnectorConfig }
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.0", date = "2016-09-09T06:05:19-07:00", comments = "Build UNNAMED.2793.f49b6c7")
public class WeatherConnectorConnectorConfigWsdlProviderAdapter implements ProcessAdapter<WsdlAdapter> , Disposable, ConnectorMetaDataEnabled, WsdlAdapter
{

    private WSResolver wsResolver;
    private ConnectorConfig config;
    protected WeatherConnectorProcessAdapter connector;
    ...
    {
        if (connector == null) {
            connector = new WeatherConnectorProcessAdapter();
     ...
     * 
     */
    public WeatherConnectorProcessAdapter getConnector() {
        if (connector == null) {
            try {
